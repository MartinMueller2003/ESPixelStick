...
/**
 * @brief Associate GPIO MUX signal with GPIO pad.
 *
 * @param gpio Pad identifier or -1 for no connection
 * @param signal_idx Signal index to connect
 * @param out_inv Output inversion flag
 * @param oen_inv Output enable inversion flag
 *
 */
